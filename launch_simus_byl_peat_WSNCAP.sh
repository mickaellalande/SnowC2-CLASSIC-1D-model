...
for experiment in "${list[@]}"; do
    ...
    sed -i "s/default_run_parameters_shrubs/default_run_parameters_shrubs_${experiment}/g" inputFiles/SnowArctic/byl/job_options_file_run_peat_${experiment}.txt
    ...
    # Launch simulation
    apptainer exec CLASSICcontainer.simg bin/CLASSIC_serial_TCZE_REF_TSNB_REF inputFiles/SnowArctic/byl/job_options_file_run_peat_${experiment}.txt 0/0 |& tee outputFiles/SnowArctic/byl/run_peat_${experiment}/output.txt
done
