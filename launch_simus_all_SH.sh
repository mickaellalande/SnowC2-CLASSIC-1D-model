...
experiments=(
    ...
    PHYS_ALL_SUBLI_v2_COMPAC_v1_SH_new
    PHYS_ALL_SUBLI_v2_COMPAC_v1_SH_bis
...
for site in "${sites[@]}"; do
	...
	if [ "${experiment}" == "PHYS_ALL_SUBLI_v2_COMPAC_v1_SH_new" ]; then
            sed -i "s/met_insitu_byl_30min_ext_2013_2019/met_insitu_byl_30min_SH_new2013_2019/g" inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt
        else
            sed -i "s/met_insitu_byl_30min_ext_2013_2019/met_insitu_byl_30min_SH_bis2013_2019/g" inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt
        fi
        ...
        # Launch simulation
        apptainer exec CLASSICcontainer.simg bin/CLASSIC_serial_PHYS_ALL_SUBLI_v2_COMPAC_v1 inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt 0/0 |& tee outputFiles/${site}/${run_prefix}_${experiment}/output.txt
    done
done
