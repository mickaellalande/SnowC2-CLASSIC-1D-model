...
for experiment in "${list[@]}"; do
    ...
    # Launch simulation
    apptainer exec CLASSICcontainer.simg bin/CLASSIC_serial inputFiles/SnowArctic/byl/job_options_file_run_peat_${experiment}.txt 0/0 |& tee outputFiles/SnowArctic/byl/run_peat_${experiment}/output.txt
done
