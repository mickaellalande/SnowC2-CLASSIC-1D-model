...
for site in "${sites[@]}"; do
    ...
    for experiment in "${experiments[@]}"; do
        ...
        cp inputFiles/${site}/job_options_file_${run_prefix}_30min_ext_snow.txt inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt
        ...
        sed -i "s/met_insitu_tvc_30min_ext_2013_2019_Snowf/met_insitu_tvc_30min_ext_${experiment}2013_2019_Snowf/g" inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt
        sed -i "s/met_insitu_tvc_30min_ext_2013_2019_TotPrecip/met_insitu_tvc_30min_ext_${experiment}2013_2019_TotPrecip/g" inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt
        ...
        # Launch simulation
        apptainer exec CLASSICcontainer.simg bin/CLASSIC_serial_PHYS_ALL_SUBLI_CORRECT_COMPAC_calonne inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt 0/0 |& tee outputFiles/${site}/${run_prefix}_${experiment}/output.txt
    done
done
