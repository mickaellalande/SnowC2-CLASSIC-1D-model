...
output_directory=/space/hall0/work/eccc/crd/ccrp/$USER/classic_outputs
...
job_options_file=$output_directory/job_options.txt
...
executable=$HOME/CLASSIC/bin/CLASSIC_parallel_intel
