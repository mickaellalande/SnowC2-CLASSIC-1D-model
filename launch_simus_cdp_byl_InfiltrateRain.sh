...
for site in "${sites[@]}"; do
    ...
    for experiment in "${experiments[@]}"; do
        ...
        # Launch simulation
        apptainer exec CLASSICcontainer.simg bin/CLASSIC_serial inputFiles/${site}/job_options_file_${run_prefix}_${experiment}.txt 0/0 |& tee outputFiles/${site}/${run_prefix}_${experiment}/output.txt
    done
done
